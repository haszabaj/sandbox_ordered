//we put all Java elements in document ready state
$(document).ready(function() {

    //FIRST:   we declare quote and author as strings

    var quote = "Information is power. But like all power, there are those who want to keep it for themselves.";
    var author = "-Aaron Swartz";

    //we daclare tweet as an empty string (to encode it)

    var tweet = "";

    //SECOND:  we set up a quoteReady function, which processes and displays newQuote acquired from WikiQuotes API
    ...
    function quoteReady(newQuote) {
        ...
        /*we set up a tweet variable to process our quote and author
        if both have more than 136 signs we use substring the quote accordingly to fit
        */
      ...
      we also change twitter share button to chnge its href into direct tweeting intention
      */
  ...
  */
    ...
    $("#getquote").click(function() {
        ...
        //queryRandomTitle is defined in WIkiquotes API - takes arguments sucess and error which we both set up as functions
